...
export default function QualifiedLeadsPage() {
  ...
  const leads = useMemo(() => allLeads?.filter(lead => lead.qualification_status === 'qualified'), [allLeads])
  ...
  const confirmMarkDNC = async () => {
    ...
    try {
      const response = await fetch(`/api/leads/${leadToMarkDNC.id}/dnc`, {
        ...
        body: JSON.stringify({
          is_dnc: true,
          reason: dncReasonInput || 'Marked from Qualified Leads page'
        }),
      })
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          ...
          <p className="text-sm text-[#004565] font-medium">Loading qualified leads...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="space-y-6">
        ...
        <Card className="border-red-200/50 shadow-lg bg-white/90 backdrop-blur-sm">
          <CardContent className="py-12 text-center">
            <p className="text-red-600 mb-2 font-semibold">Error loading qualified leads</p>
      ...
      {leads && leads.length > 0 ? (
        ...
        <Card className="border-[#004565]/20 shadow-lg bg-white/90 backdrop-blur-sm">
          <CardContent className="py-12 text-center">
            ...
            <p className="text-[#004565] font-medium mb-2">No qualified leads found</p>
            <p className="text-[#004565]/70 text-sm mb-4">Qualify leads from the main list to see them here.</p>
